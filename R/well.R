...
well <- R6::R6Class(classname = "well",
                    public = list(
                      ...
                      #' @param well_minus10_weight Object of class {\link[base]{integer}} expected. Catch weight of individuals in the less than 10 kg category (by well, in tonne, considering all species).
                      #' @param well_plus10_weight Object of class {\link[base]{integer}} expected. Catch weight of individuals in the over 10 kg category (by well, in tonne, considering all species).
                      #' @param well_global_weight Object of class {\link[base]{integer}} expected. Catch weight of individuals (less and more than 10kg categories, by well, in tonne, considering all species).
