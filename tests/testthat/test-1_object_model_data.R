...
test_that(desc = "101. Comparison activities between data extracted and data model",
          code = {
...
test_that(desc = "102 - Comparison elementary catches between data extracted and data model",
          code = {
            expect_equal(object = length(unique(elementarycatches$elementarycatch_id)),
...
test_that(desc = "103 - Comparison elementary landings between data extracted and data model",
          code = {
            expect_equal(object = length(unique(elementarylandings$elementarylanding_id)),
...
test_that(desc = "104 - Comparison steps data between data extracted and data model",
          code = {
            expect_equal(object = dim(lengthsteps),
...
test_that(desc = "105 - Comparison weight relationships data between data extracted and data model",
          code = {
            expect_equal(object = nrow(lengthweightrelationships),
...
test_that(desc = "106 - Comparison wells data between data extracted and data model",
          code = {
            expect_gte(object = length(unique(samples$well_id)),
...
test_that(desc = "107 - Comparison samples data between data extracted and data model",
          code = {
            expect_gte(object = nrow(samples),
...
test_that(desc = "108 - Comparison sample sets data between data extracted and data model",
          code = {
            expect_equal(object = dim(samplesets),
...
test_that(desc = "109 - Comparison set duration references data between data extracted and data model",
          code = {
            expect_equal(object = dim(setdurationrefs),
...
test_that(desc = "110 - Comparison trips between data extracted and data model",
          code = {
