...
<img style="display: block; margin-left: auto; margin-right: auto; width: 80%;" src='process_1.5.png'/>

### Process 1.6: Time at sea estimation

<img style="display: block; margin-left: auto; margin-right: auto; width: 90%;" src='process_1.6.png'/>

# level 1.7: Fishing time determination ----

<img style="display: block; margin-left: auto; margin-right: auto; width: 80%;" src='process_1.7.png'/>

# level 1.8: Searching time process ----

<img style="display: block; margin-left: auto; margin-right: auto; width: 80%;" src='process_1.8.png'/>
