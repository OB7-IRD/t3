...
output: 
  bookdown::html_document2:
    ...
    toc_float: true
description: |
  Description of the t3 level 1 logbooks standardisation and how to initialise it.
pkgdown:
  as_is: true
vignette: >
...
|---------------------------------------------------|--------------------------------|----------------------|--------------|
| Process 1.1: Raising Factors level 1              | `rf1()`                        | full_trips           |              |
| Process 1.2: logbook weight categories conversion | `conversion_weight_category()` | full_trips           |              |
| Process 1.3: positive sets count                  | `set_count()`                  | full_trips           |              |
| Process 1.4: Fishing effort indicators calculation | `fishing_effort()`            | full_trips           | In hours     |
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 100%;" src='figures/rf1.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 90%;" src='figures/process_1.1.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 50%;" src='figures/process_1.2.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 50%;" src='figures/standard_weight_categories.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 80%;" src='figures/process_1.3.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 60%;" src='figures/process_1.4.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 90%;" src='figures/process_1.5.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 110%;" src='figures/process_1.6.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 100%;" src='figures/process_1.7.png'/>
...
<img style="display: block; margin-left: auto; margin-right: auto; width: 60%;" src='figures/process_1.8.png'/>
