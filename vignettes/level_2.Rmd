...
<img style="display: block; margin-left: auto; margin-right: auto; width: 70%;" src='figures/LWR.png'/>

<div style="text-align: center"> Figure 6: Example of Length-weight relationship fitted for yellowfin tuna (YFT, *Thunnus albacares*) caught in the Indian ocean (from Chassot et al. - IOTC-2016-WPDCS12).</div>

In addition, you will find below in the table 2 the reference table for the length weight relationship and global process flowchart in the figure 7.
...
<div style="text-align: center">Figure 7: Sample number standardization flowchart.</div>
...
<div style="text-align: center">Figure 8: Raised factors determination flowchart.</div>
...
The global process flowchart is available in the figure 9 below.

<img style="display: block; margin-left: auto; margin-right: auto; width: 100%;" src='figures/process_2.8.png'/>

<div style="text-align: center">Figure 9: Samples number standardization at set scale flowchart.</div>
